...
- [1. 基础知识](#1-基础知识)
    - [1.1. 了解protocol buffer3](#11-了解protocol-buffer3)
    - [1.2. protocol buffer 3和json](#12-protocol-buffer-3和json)
    - [1.3. websocket和http](#13-websocket和http)
    - [1.4. 交易执行的基本过程](#14-交易执行的基本过程)
    - [1.5. 试一试](#15-试一试)
- [2. HTTP接口](#2-http接口)
    - [2.1. 查询账号](#21-查询账号)
    - [2.2. 查询交易](#22-查询交易)
    ...
    - [2.5. 序列化交易](#25-序列化交易)
- [3. 定义交易](#3-定义交易)
    - [3.1. 交易的基本结构](#31-交易的基本结构)
    - [3.2. 操作](#32-操作)
        - [3.2.1. 操作码](#321-操作码)
        - [3.2.2. 创建账号](#322-创建账号)
        - [3.2.3. 发行资产](#323-发行资产)
        - [3.2.4. 转移资产](#324-转移资产)
        - [3.2.5. 设置metadata](#325-设置metadata)
        - [3.2.6. 设置权重](#326-设置权重)
        - [3.2.7. 设置门限](#327-设置门限)
- [4. 高级功能](#4-高级功能)
...
2. 交易对象序列化(protocol buffer 3格式)为字节流 `transaction_blob`
